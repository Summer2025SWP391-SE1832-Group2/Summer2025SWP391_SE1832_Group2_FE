...
const featuredPost: Post = {
  ...
  description:
    "Lorem ipsum dolor sit amet, consectetur adipisicing elit. Vero temporibus repudiandae, inventore pariatur numquam cumque.",
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-10 grid md:grid-cols-3 gap-10">
      ...
      <div className="md:col-span-1">
        <img src={featuredPost.image} alt="featured" className="rounded-lg w-full h-64 object-cover" />
        <p className="text-sm text-gray-500 mt-4 uppercase">{featuredPost.category} • {featuredPost.date}</p>
        <h2 className="text-2xl font-bold mt-2">{featuredPost.title}</h2>
        <p className="text-gray-600 mt-2 text-sm">{featuredPost.description}</p>
        <div className="flex items-center mt-4">
          <img src="https://i.pravatar.cc/40?img=3" alt="author" className="rounded-full w-8 h-8 mr-2" />
