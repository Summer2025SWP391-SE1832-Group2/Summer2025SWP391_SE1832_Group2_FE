...
export default function BlogManagementPage() {
  ...
  return (
    <div className="grid grid-cols-3 gap-6 p-6 h-screen overflow-hidden">
      ...
      <h2 className="text-xl font-bold sticky top-0 bg-white dark:bg-background z-10 pb-2">Loại Blog</h2>
        <Button
    variant="outline"
    size="icon"
  >
    <Plus className="w-5 h-5" />
        ...
        {blogTypes.map((type) => (
          ...
          >
            ...
            >
              <img src={type.img} alt={type.title} className="w-full h-32 object-cover rounded-md" />
              <div>
  ...
  <h2 className="text-xl font-bold">
    {selectedBlogType ? `Blogs thuộc ${selectedBlogType.title}` : "Chọn loại blog để xem bài viết"}
  </h2>
  <Button
    variant="outline"
    size="icon"
